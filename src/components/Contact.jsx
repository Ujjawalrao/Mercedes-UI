...
function Contact() {
  return (
    <>
      <section id='Contact' className=' px-[40px] h-[80vh] lg:h-[130vh] w-full bg-[url("https://www.mercedes-benz.com/content/dam/brandhub/assets/vehicles/cla/pad/pictures/05-cla-pad-xl-switcher-3840x2160.jpg/_jcr_content/renditions/image-crop-default.jpeg/1744726815729.jpg?im=Resize=(1680);Crop,rect=(0,0,1680,946)")] bg-no-repeat bg-center bg-cover '>
