  ...
  return (
    <>
      <div className="w-full fixed top-0 z-40">
        ...
        {/* navbar start */}
        <nav className="w-full h-[80px] bg-transparet flex items-center gap-4">
          <div
            id="logo-bg"
            className="bg-[var(--bg-dark-color)] z-30 inline-block w-[150px] pl-[50px] h-full"
          >
