      ...
      >
        <div className="relative w-full lg:w-[80%] overflow-hidden outline-none border-none  h-[95vh] lg:h-full rounded-4xl">
          ...
          <div className="absolute bottom-0 flex justify-center items-center left-0 rounded-tr-3xl bg-[var(--bg-dark-color)] h-[10%] w-[50%]">
            ...
            className="lg:text-3xl md:text-2xl text-[12px] font-semibold font-serif inline-block">
              Dawn of a new era.
            </motion.h1>
          </div>
        </div>
        <div className=" w-full lg:w-[20%] h-[90vh] lg:h-full rounded-4xl flex flex-col gap-4">
          ...
          <div className="relative h-[55%] w-full rounded-3xl overflow-hidden ">
            <video className="w-full object-center"
            ...
            ></video>
            {/*  */}
            <div className="absolute bg-[var(--bg-dark-color)] bottom-0 right-0 pt-3 pl-3 rounded-tl-4xl text-xl">
              <div className="rounded-full border-2 py-2 px-3 ">
                <i
